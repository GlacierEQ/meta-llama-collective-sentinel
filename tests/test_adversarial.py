...
class AdversarialEliteTests(unittest.TestCase):
    def _load(self):
        errors = []
        for name in ('meta_llama_collective_sentinel', "src." + 'meta_llama_collective_sentinel'):
            try:
    ...
    def test_refuse_bad_import_path_does_not_shadow(self):
        with self.assertRaises(ModuleNotFoundError):
            importlib.import_module("src.__elite_does_not_exist_" + 'meta_llama_collective_sentinel')
